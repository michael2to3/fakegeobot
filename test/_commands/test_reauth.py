...
from bot._commands import Reauth
...
from bot._user import RequestCode
...
class TestReauth(asynctest.TestCase):
    ...
    async def test_handle(self):
        try:
            ...
            code_command = Reauth(self.bot.context, self.text_helper)

            update.message.location = None
            update.message.chat_id = 1
            update.message.text = "/reauth"
